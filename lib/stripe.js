...
export const TIER_COPY = {
  premium: {
    name: "Wedding Bets — Premium",
    description:
      "Unlimited guests and questions, all themes including dark mode, custom colours, your logo, and a recap page. One payment for one wedding.",
  },
};
