...
export async function updateSession(request, response) {
  ...
  // A dead or paused project makes getUser hang until undici times out, which
  // makes every click feel broken. Fail fast and treat the request as signed
  // out so marketing pages still navigate.
  try {
